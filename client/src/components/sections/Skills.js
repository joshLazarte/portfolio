...
const Skills = () => {
  return (
    <section className='app-skills'>
      <h2 className='app-skills__title'>
        Primary <span>Skillset</span>
      </h2>
      <div className='line' />
      <h3 className='app-skills__heading'>
        <span className='icon solid fa-code' /> Front End
      </h3>
      <div className='line2' />
      <ul className='app-skills__list'>
        <li className='app-skills__list-item'>
      ...
      <ul className='app-skills__list'>
        ...
        <li className='app-skills__list-item'>
          Simple <strong>UFW</strong> configuration and
          <strong>SSH</strong> key access
        </li>
      </ul>
    </section>
  );
